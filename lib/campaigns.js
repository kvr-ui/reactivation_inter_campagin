...
const CAMPAIGNS = {
  ...
  // Leads who tap "START SMALL". Same arrangement as prep: the reactivation
  // database, its own collection. Shown in the chat under FINANCIAL AID.
  startsmall: {
    key: 'startsmall',
    keyword: 'START SMALL',
    aliases: [],
    ...
    urlEnv: 'MONGO_URL',
    dbEnv: 'DB_NAME',
    collection: 'start_small',
  },

  // Leads who tap "STUDY EFFECTIVELY". Same arrangement as prep: the
  // reactivation database, its own collection. Shown in the chat under
  // OFFICE CLASS.
  studyeffectively: {
    key: 'studyeffectively',
    keyword: 'STUDY EFFECTIVELY',
    aliases: [],
    label: 'OFFICE CLASS',
    urlEnv: 'MONGO_URL',
    dbEnv: 'DB_NAME',
    collection: 'study_effectively',
  },
